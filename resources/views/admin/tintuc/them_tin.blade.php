    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- /.container-fluid -->
                <div class="container">
                <h3 class="text-center">Thêm bài viết</h3><hr>
                        ...
                        <div class="col-12">
                            <form method="POST" role="form" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tieu_de" name="tieu_de" placeholder="Nhập tiêu đề tin tức" >    
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="mo_ta_ngan" class="form-control"  id="summernote1" cols="30" rows="10"></textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="noi_dung" class="form-control"  id="summernote" cols="30" rows="10"></textarea>
                                    </div>
                                    @if($errors->has('noi_dung'))
                                        <div class="alert alert-danger alert-block">
                                            <button type="button" class="close" data-dismiss="alert">×</button>	
