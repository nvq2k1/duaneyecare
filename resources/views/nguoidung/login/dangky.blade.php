...
<body>
    ...
    <div class="wrapper">
       ...
       <!-- Register Account Start -->
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="register-title">
                            ...
                            <p class="mb-10">Nếu bạn đã có tài khoản, vui lòng đăng nhập tại <a href="/dang-nhap" style="text-decoration:underline">đây</a></p>
                        </div>
                    </div>
                </div>
                <!-- Row End -->
                        ...
                        <form class="form-register" action="#" method="POST">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group d-md-flex align-items-md-center">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="" name="ten_tv" placeholder="Mời nhập họ tên đầy đủ">
                                    </div>
                                </div>
                                <div class="form-group d-md-flex align-items-md-center">
                                    <label class="control-label col-md-2" for="email"><span class="require">*</span>Email của bạn</label>
                                    <div class="col-md-10">
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Mời nhập địa chỉ email">
                                    </div>
                                </div>
                                <div class="form-group d-md-flex align-items-md-center">
                                    <label class="control-label col-md-2" for="number"><span class="require">*</span>Số điện thoại</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="number" name="sdt" placeholder="Mời nhập số điện thoại">
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset>
                                ...
                                <div class="form-group d-md-flex align-items-md-center">
                                    ...
                                    <div class="col-md-10">
                                        <input type="password" class="form-control" id="pwd" name="mat_khau" placeholder="Mời nhập mật khẩu">
                                    </div>
                                </div>
                                <div class="form-group d-md-flex align-items-md-center">
                                    <label class="control-label col-md-2" for="pwd-confirm"><span class="require">*</span>Xác nhận lại mật khẩu</label>
                                    <div class="col-md-10">
                                        <input type="password" class="form-control" id="pwd-confirm" name="mat_khau_cf" placeholder="Mời nhập mật khẩu lần 2">
                                    </div>
                                </div>
                            </fieldset>
                            <div class="terms">
        ...
        <div class="off-white-bg2 support-area bdr-top">
            <div class="container">
                <div class="d-flex flex-wrap">
                    ...
                    <div class="single-support">
                        ...
                        <div class="support-desc">
                            <h6>Đo mắt miễn phí</h6>
                            <span>KTV nhiều kinh nghiệm</span>
                        </div>
                    </div>
                    <div class="single-support">
                        <div class="support-icon">
