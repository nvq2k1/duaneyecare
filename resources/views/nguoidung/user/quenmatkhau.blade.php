        ...
        <div class="container">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 ml-2 font-weight-bold text-primary">Xác nhận Email</h6><br>
                </div>
                @include('admin.thongbao')
                
                <div class="card-body">
                    <form method="POST" role="form" enctype="multipart/form-data" action="/xac-nhan-email">
                        @csrf 
                        <div class="row">
                            <div class="form-group col-6 ">
                                <label for="dia_chi">Email</label>
                                <input type="email" class="form-control" id="email" name="email" placeholder="Nhập Email của tài khoản bạn cần khôi phục ..."   value="">    
                            </div>
                        </div>
