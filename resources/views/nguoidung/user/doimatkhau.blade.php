        ...
        <div class="container">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Đổi mật khẩu</h6><br>
                </div>
                @include('admin.thongbao')
                
                <div class="card-body">
                    <form method="POST" role="form" enctype="multipart/form-data" action="/doi-mat-khau-db">
                        @csrf 
                        <input type="hidden" class="form-control" id="ma_tv" name="ma_tv"   value="{{Auth::guard('thanhvien')->user()->ma_tv}}" >
                        <div class="form-group">
                            <label for="sdt">Mật khẩu cũ</label>
                            <input type="password" class="form-control" id="sdt" name="password_old"  value="">    
                        </div>
                        <div class="form-group">
                            <label for="dia_chi">Mật khẩu mới</label>
                            <input type="password" class="form-control" id="dia_chi" name="password_new"   value="">    
                        </div>
